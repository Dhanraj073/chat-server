...
var addPieChart= function(startX,startY,width,height,myid,color,flagLabel,flagSlicing,flagTooltip,flagScroll,flagSelection,data,val)
{
   ...
   var path2 =svg.selectAll('.arc')
    ...
    path.append('path')
        ...
        .attr("class","chartPie_class_chart")
        .attr('d', arc)
        .transition()
        .duration(500)
